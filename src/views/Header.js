...
import logo from "../assets/images/branding/logo-text.png";
...
function Header(props) {
  ...
  if (props.location.pathname.startsWith("/forum")) {
    return <ForumHeader />;
  }

  return (
    <Navbar className="fixed-header" collapseOnSelect expand="md" bg="light" sticky="top">
      <Container>
        <Navbar.Brand as={Link} to="/">
          <img alt="unite" src={logo} className="d-inline-block align-top logo" />
        </Navbar.Brand>
